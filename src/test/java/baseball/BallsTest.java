...
public class BallsTest {
    ...
    void play_nothing() {
        ...
        assertThat(nothingResult.getStrikeCnt()).isEqualTo(0);
        assertThat(nothingResult.getBallCnt()).isEqualTo(0);
    }
    @Test
    void play_1strike_1ball() {
        PlayResult ballResult = answer.play(List.of(4, 1, 3)); // 1스트라이크 1볼
        assertThat(ballResult.getStrikeCnt()).isEqualTo(1);
        assertThat(ballResult.getBallCnt()).isEqualTo(1);
    }
    @Test
    void play_3strike() {
        PlayResult ballResult = answer.play(List.of(1, 2, 3)); // 3스트라이크
        assertThat(ballResult.getStrikeCnt()).isEqualTo(3);
        assertThat(ballResult.getBallCnt()).isEqualTo(0);
